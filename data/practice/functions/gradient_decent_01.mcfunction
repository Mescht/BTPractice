...
execute if score d dist matches 0 if score i dist matches 0 run function practice:error_no_bt

execute if score d dist matches 1.. run function practice:gradient_decent_02
execute if score d dist matches 0 if score i dist matches 1.. run function practice:gradient_decent_02