...
# Reset PB
tellraw @a [{"text":"   [Reset PB]","color":"red","clickEvent":{"action":"run_command","value":"/function practice:menu/stats/reset_pb_dialog"}},{"text":" [Reset All Recrods]","color":"red","clickEvent":{"action":"run_command","value":"/function practice:menu/stats/reset_records_dialog"}}]
