...
# reset logic
execute if score reset_hos settings matches 1 as @a[scores={reset_hos=1..}] run function practice:locate/findbt
execute if score reset_shovel settings matches 1 as @a[scores={reset_shovel=1..}] run function practice:locate/findbt
execute if score reset_fish settings matches 1 as @a[scores={reset_cod=1..}] run function practice:locate/findbt
execute if score reset_fish settings matches 1 as @a[scores={reset_salmon=1..}] run function practice:locate/findbt
execute if score reset_openbt settings matches 1 as @a[scores={chest_opened=1..}] run function practice:locate/findbt
